...
<section class="section-scaffolding">
	...
	<h2 class="scaffolding-heading" id="<?php esc_html_e( 'typography', 'ei_test' ); ?>">
		<?php esc_html_e( 'Typography', 'ei_test' ); ?></h2>
	...
	print_scaffolding_section(
		[
			...
			'usage'       => '<del>_s</del>',
			'output'      => '<p>We use <del>_s</del> ei_test to build themes.</p>',
		]
	);
