...
use function WebDevStudios\ei_test\print_global_scaffolding_section;

?>

<section class="section-scaffolding">

	<h2 class="scaffolding-heading" id="<?php esc_html_e( 'globals', 'ei_test' ); ?>"><?php esc_html_e( 'Globals', 'ei_test' ); ?></h2>
